	...
	<div class="addEdit-block" :style='{"padding":"0px 3%"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="select" v-if="type!='info'"  label="是否有机" prop="shifouyouji">
					<el-select :disabled="ro.shifouyouji" v-model="ruleForm.shifouyouji" placeholder="请选择是否有机" >
						<el-option
							v-for="(item,index) in shifouyoujiOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' v-else class="input" label="是否有机" prop="shifouyouji">
					<el-input v-model="ruleForm.shifouyouji"
						placeholder="是否有机" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' v-else class="input" label="品牌" prop="pinpai">
					<el-input v-model="ruleForm.pinpai" placeholder="品牌" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="规格包装" prop="guigebaozhuang">
					<el-input v-model="ruleForm.guigebaozhuang" placeholder="规格包装" clearable  :readonly="ro.guigebaozhuang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' v-else class="input" label="规格包装" prop="guigebaozhuang">
					<el-input v-model="ruleForm.guigebaozhuang" placeholder="规格包装" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' v-else class="input" label="产地" prop="chandi">
					<el-input v-model="ruleForm.chandi" placeholder="产地" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="单限" prop="onelimittimes">
					<el-input v-model="ruleForm.onelimittimes" placeholder="单限" clearable  :readonly="ro.onelimittimes"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' v-else class="input" label="单限" prop="onelimittimes">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' v-if="type!='info'"  label="农产品介绍" prop="nongchanpinjieshao">
					<editor 
						...
						v-model="ruleForm.nongchanpinjieshao" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
...
export default {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='nongchanpintupian'){
							this.ruleForm.nongchanpintupian = obj[o];
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.nongchanpinjieshao = this.ruleForm.nongchanpinjieshao.replace(reg,'../../../springbootw1eo4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.nongchanpintupian!=null) {
		this.ruleForm.nongchanpintupian = this.ruleForm.nongchanpintupian.replace(new RegExp(this.$base.url,"g"),"");
	}
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   ...
					   if (data && data.code === 0) {
						 ...
						 this.parent.rexiaonongchanpinCrossAddOrUpdateFlag = false;
						 this.parent.search();
